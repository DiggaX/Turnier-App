...
import { ParticipantShell, SectionLabel } from "@/components/brand/participant-shell";
...
export function ScorekeeperClient({
  ...
  const pairing = [match.participant_a_name ?? "TBD", match.participant_b_name ?? "TBD"].join(" vs ");
